...
export const ProductsPage2 = observer(function ProductsPage() {
  const { productsUiStore: ui } = useStore();

  const { search, setSearch, category, setCategory, page, setPage } = ui;
  ...
  console.log("ProductsPage2 rendered");
