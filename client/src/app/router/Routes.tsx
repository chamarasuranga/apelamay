...
import { ProductsPage2 } from "../../features/products/ProductsPage2";
import Goals from "../../features/goals/Goals";
import SalonSchedulerPage from "../../features/scheduler/SalonSchedulerPage";
import Scheduler2Page from "../../features/scheduler2/Scheduler2Page";
...
export const router = createBrowserRouter([
    {
        ...
        children: [
            {element: <RequireAuth />, children: [
                ...
                { path: 'course-goals', element: <Goals /> },
                { path: 'scheduler', element: <SalonSchedulerPage /> },
                { path: 'scheduler2', element: <Scheduler2Page /> },
            ]},
